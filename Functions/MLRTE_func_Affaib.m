function [ moyenne ,confM ] = MLRTE_func_Affaib( a,d1,d2,d3,d4,d5,N,kernel, F1_Score_Class,F1_Score_Totat,confMat )
        ...
        for i = 1 : getsize(test,1)
            ...
            if( getsize(a,3) == 3) %on a 3 classes
                ...
                if nargin > 8
                    ...
                    masseTab=masseTab_old.*F1_Score_Class;
                    
                    for b=1:getsize(a,2)
                        v=(1-F1_Score_Class(:,b)).*masseTab_old(:,b);
